        ...
        <div class="row">
          <div class="col-lg-10 m-auto">
            ...
            <div class="d-flex banner-buttons">
              <a class="btn btn-black hero-banner-btn-job mr-2" href="#"
                >Looking for a Jobs</a
              >
              <a class="btn btn-black hero-banner-btn-employee" href="#"
                  ...
                  <div class="col-md-12 text-left">
                    ...
                    <p class="pt-1 pb-2 mb-0">
                      <span class="news-text"
                        >See the latest information on BizBlanca</span
                      >
                    </p>
                  </div>
                </div>
          ...
          <div class="col-12 col-md-6 p-0" id="content-faq-anker">
            <div id="content-faq-head">
              <a href="./comming.html" class="job-head">
                <div>
                  ...
                  <span class="text-center btn-look"
                    >View more Detail
                    <i class="fa fa-long-arrow-right" aria-hidden="true"></i
                  ></span>
                </div>
            ...
            <div class="content-faq-anker parent">
              <div class="child bg-one">
                <a href="#"
                  ><span class="looking-h">Looking for a job?</span></a
                >
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 p-0" id="social-media-anker">
            ...
            <div class="parent right social-media-anker">
              <div class="child bg-two">
                <a href="#"
                  ><span class="looking-h">Looking for employees?</span></a
                >
              </div>
            </div>
          </div>
        ...
        <div class="row justify-content-center list-socaial">
          <div class="col-md-4 p-0 my-2">
            <div class="list__card">
              ...
              <a
                class="list__card-link minor-button-right"
                tabindex="0"
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6 movie-wrap-text">
                  ...
                  <div
                    id="contact-section"
                    class="col-12 anker-list d-flex w-100 pt-2 mt-4 px-0"
                  >
                    <a href="./comming.html" class="videoview-list-anker"
                      >Read More
                      <i class="fa fa-long-arrow-right" aria-hidden="true"></i
                    ></a>
                  </div>
            ...
            <form action="" class="">
              <div class="row m-0">
                ...
                <div class="col-12 px-2">
                  <div class="form-group">
                    ...
                    <textarea
                      rows="4"
                      type="text"
                      class="form-control pl-3 message-box"
                      placeholder="Message"
                      name=""
                      id=""
                      required
                ...
                <div class="col-12 px-2 py-4">
                  <a href="./comming.html" class="contact-submit-anker"
                    >Send
                  </a>
                </div>
              </div>
