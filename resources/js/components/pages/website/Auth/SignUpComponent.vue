                                                ...
                                                <div class="col-12 registerTab">
                                                    <div class="loginFeilds">
                                                        <div class="form-group">
                                                            <input class="is-invali" type="text" v-model="candidate_record.name" placeholder="Your Name" name="name" id="name-input" />                                    
                                                            <small>
                                                        ...
                                                        <br />
                                                        <div class="form-group">
                                                            <input class="is-invali" type="email" v-model="candidate_record.email" placeholder="Email" name="email" id="email-input" />
                                                            <small>
                                                        ...
                                                        <br />
                                                        <div class="form-group"> 
                                                            <input class="is-invali" type="number" v-model="candidate_record.phone" placeholder="Phone Number" name="phone" id="phone-no-input" />
                                                            <small>
                                                        ...
                                                        <br />
                                                        <div class="form-group">
                                                            <input class="is-invali" type="password" v-model="candidate_record.password" placeholder="Password" name="password" id="password-input" />
                                                            <small>
                                                        ...
                                                        <br />
                                                        <div class="form-group">
                                                            <input class="is-invali" type="password" v-model="candidate_record.confirm_password" placeholder="Confirm Password" name="password_confirmation" id="confirm-password-input" />
                                                            <small>
