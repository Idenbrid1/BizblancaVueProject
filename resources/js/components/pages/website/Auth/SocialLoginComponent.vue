                                ...
                                <div class="col-md-8 col-12 right-login">
                                    ...
                                    <div class="login-feilds">
                                        ...
                                        <ul class="AuthRadioButtons">
                                            <li>
                                                <input type="radio" v-model="record.role" value="candidate"
                                                    hidden="hidden" name="category" id="indiviualsFeild">
                                                <label for="indiviualsFeild" class="indiviualsLabel ml-0">
                                                    <i class="fas fa-user" aria-hidden="true"></i>
                                                    As Candidate
                                                </label></li>
                                            <li>
                                                <input type="radio" v-model="record.role" value="company"
                                                    hidden="hidden" name="category" id="businessLabel">
...
<style scoped>
    ...
    #indiviualsFeild[type=radio]:checked+label,
    #businessLabel[type=radio]:checked+label {
