        ...
        <div class="container cont-flex PostJobContainer">
            <div class="col-sm-12 col-md-12 col-lg-12 xs-padding pt-3">
                ...
                <div class="job-list-wrap">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 xs-padding p-0 pt-5">
                        <div class="px-2">
                            <h1 class="post_new_job_title">Related Jobs</h1>
                            <p class="post_new_job_descrp">
                                This section is related jobs section offered by other companies of same position you are
                                looking for and may or may not better option then this job post and also you can check
                                these jobs.
                            </p>
                        </div>
                        <!-- Job List Wrap Start -->
