         ...
         <div class="container">
            <div class="footer__main row">
               ...
               <div class="col-lg-4 col-12 offset-lg-1 p-0">
                  ...
                  <input type="text" class="form-control pl-2" placeholder="Enter Email" name="" id="" maxlength="50"
                     required="">
                  <div class="footer__sign-up">
                     <input type="submit" class="mail-subscribe-btn mt-3" value="Subscribe">
                  </div>
               </div>
            </div>
            <div class="row">
         ...
         <div class="copyright-main">
            <div class="container company-rights py-1">
               ...
               <ul class="social-icons-footer">
                  ...
                  <li><a href="https://api.whatsapp.com/send?phone=+923404913508"><i class="fab fa-whatsapp-square"></i></a></li>
